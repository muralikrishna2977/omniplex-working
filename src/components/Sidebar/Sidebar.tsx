...
// New Checkout Icons
import Checkout from "../../../public/svgs/sidebar/Checkout.svg";
import CheckoutInactive from "../../../public/svgs/sidebar/Checkout_Inactive.svg";
...
const Sidebar = () => {
  ...
  const [selected, setSelected] = useState<"history" | "library" | "settings" | "plugins" | "profile" | "checkout">("history");
            ...
            <div className={styles.barContainer}>
              ...
              <div className={styles.iconContainer}>
                <div>
                  ...
                  {selected === "checkout" ? (
                    <Image src={Checkout} alt="Checkout" className={styles.iconActive} />
                  ) : (
                    <Image
                      src={CheckoutInactive}
                      alt="Checkout"
                      className={styles.icon}
